import numpy as np
from jupyter_server.tests.test_serverapp import test_observed_root_dir_does_not_update_preferred_dir
...
class CrowdHumanDataSet(Dataset):
    ...
    def __init__(self, crowdhuman_root, transforms=None, txt_name: str = "train.txt"):
        ...
        if "CrowdHuman" in crowdhuman_root:
            ...
            self.root = os.path.join(crowdhuman_root, "CrowdHuman")
        self.img_root = os.path.join(self.root, "JPEGImages", txt_name.split('.')[0], 'Images')
        self.annotations_root = os.path.join(self.root, "Annotations", txt_name.split('.')[0])
        # print("annotations_root:"+self.annotations_root)
